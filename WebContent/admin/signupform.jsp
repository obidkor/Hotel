<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="upload/Hotelmenu.png" alt="" width="72" height="72">
...
<form class="needs-validation" method="post" action="?contentPage=admin/signupwrite.jsp" novalidate>
  <hr class="mb-4">
  
        <div class="custom-control custom-checkbox" style="text-align:left;">
          <input type="checkbox" class="custom-control-input" id="agree" name="agree" value="1" required>
          <label class="custom-control-label" for="agree">회원가입 약관에 동의합니다.</label>
        </div>
  <hr class="mb-4">
    <div class="col-md order-md" style="text-align:left;">
      <h4 class="mb-3">회원가입</h4>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="password" name = "password" placeholder="패스워드" value="" required>
            <div class="invalid-feedback">
